...
# 定制请求头
headers = {'Referer':'https://www.mzitu.com/xinggan/','User-Agent':'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36'}

path = 'D:/python/meizitu/'
meizi_url = []
meizitu_img = []

start_url = 'https://www.mzitu.com/page/'
...
# print(meizi_url)
# print(meizitu_img)
with open("D:/python/meizitu/meizi-main-jpg.txt", "w") as fo:
    x = 1
    y = 1
